...
#histogram new_sp_m04
#myPlot.new_sp_m04 <- myPlot + aes(x=new_sp_m04) + geom_histogram(bins = 12,fill = "yellow", col = "black")
#myPlot.new_sp_m04
...
myPlot.new_sp_f014 <- myPlot + aes(x=new_sp_f014) + geom_histogram(bins = 12,fill = "magenta", col = "black")
myPlot.new_sp_f014

#histogram new_sp_m65
myPlot.new_sp_m65 <- myPlot + aes(x=new_sp_m65) + geom_histogram(bins = 12,fill = "green1", col = "black")
myPlot.new_sp_m65

#histogram new_sp_f65
myPlot.new_sp_f65 <- myPlot + aes(x=new_sp_f65) + geom_histogram(bins = 12,fill = "purple1", col = "black")
myPlot.new_sp_f65
```
...
ggplot(tbCan, aes(x = year, y = new_sp_m014)) +
  ...
  labs(x = "Year", y = "Positive TB Tests", title = "Positive TB Tests Over Years")
```
```
...
ggplot(tbCan, aes(x = year, y = new_sp_f65)) +
  geom_line(color = 'maroon') +
  geom_point(color = 'maroon') +
  geom_text(aes(label = year), angle = 90, size = 3, hjust = 1.25)
  labs(x = "Year", y = "Positive TB Tests", title = "Positive TB Tests Over Years")
